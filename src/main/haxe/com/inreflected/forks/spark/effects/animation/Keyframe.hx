 ...
 *  </pre>
 *
 *  @see com.inreflected.forks.spark.effects.animation.MotionPath
 *
...
class Keyframe
{
     ...
     *  @productversion Flex 4
     */
	public function new(time : Null<Float> = null, value : Null<Float> = null, valueBy : Dynamic = null)
	{
        if (time == null)
            time = Math.NaN;
        if (value == null)
     ...
     */
	static var linearEaser : IEaser = new Linear();
	/**
